...
<html lang="es" dir="ltr">
  ...
  <body>
    <header>
      <h1 style="margin:0%; padding:0%;">Ejercicio 2 Include</h1>
    </header>
    <div class="cont">

      <h1>En este ejemplo se utiliza la funcion Include() que ubica codigo php definido en el archivo ejemplo2.inc</h1>
      <h1>Antes de insertar el include las variables declaradas en el mismo no existen</h1>
      ...
      <?php include("./archivo.inc"); ?>
      <h1>Aquí ya se ejecutó la función include(). Cuando se usa include ocurre que si el archivo 'Inc' no existe, se visualiza un warning y el script sigue ejecutándose hasta el final</h1>
